...
string(REPLACE ":" ";" GPERFTOOLS_INCLUDE_DIR_HINTS
               "$ENV{GPERFTOOLS_INCLUDE_DIR_HINTS}")
...
# Find library
string(REPLACE ":" ";" GPERFTOOLS_LIBRARY_DIR_HINTS
               "$ENV{GPERFTOOLS_LIBRARY_DIR_HINTS}")
string(REPLACE ":" ";" LIBRARY_PATH "$ENV{LIBRARY_PATH}")
string(REPLACE ":" ";" LD_LIBRARY_PATH "$ENV{LD_LIBRARY_PATH}")
list(
  APPEND
  GPERFTOOLS_CHECK_LIBRARY_DIRS
