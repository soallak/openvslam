...
class viewer {
 ...
 private:
   ...
   * @param width
   */
  void draw_camera(const pangolin::OpenGlMatrix& gl_cam_pose_wc,
   ...
   * @param width
   */
  void draw_camera(const openvslam::Mat44_t& cam_pose_wc,
                   const float width) const;
   ...
   */
  void draw_line(const float x1, const float y1, const float z1, const float x2,
                 const float y2, const float z2) const;
