...
class keyframe_inserter {
 public:
  explicit keyframe_inserter(
      const double max_interval = 1.0,
   ...
   */
  std::shared_ptr<data::keyframe> insert_new_keyframe(
 ...
 private:
  ...
  //! Ratio-threshold of "the number of 3D points observed in the current frame"
  //! / "that of 3D points observed in the last keyframe"
