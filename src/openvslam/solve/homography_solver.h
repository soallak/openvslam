...
class homography_solver {
 public:
  ...
  //! Constructor
  homography_solver(const std::vector<cv::KeyPoint>& undist_keypts_1,
  ...
  static Mat33_t compute_H_21(const std::vector<cv::Point2f>& keypts_1,
                              const std::vector<cv::Point2f>& keypts_2);

  //! Decompose a homography matrix to eight pairs of rotation and translation
  static bool decompose(const Mat33_t& H_21, const Mat33_t& cam_matrix_1,
