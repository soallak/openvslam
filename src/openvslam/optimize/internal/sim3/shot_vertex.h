...
inline shot_vertex::shot_vertex() : g2o::BaseVertex<7, g2o::Sim3>() {}
...
inline void shot_vertex::setToOriginImpl() { _estimate = g2o::Sim3(); }

inline void shot_vertex::oplusImpl(const g2o::number_t* update_) {
