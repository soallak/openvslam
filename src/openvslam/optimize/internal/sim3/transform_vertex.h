...
inline transform_vertex::transform_vertex() : g2o::BaseVertex<7, g2o::Sim3>() {}
...
inline void transform_vertex::setToOriginImpl() { _estimate = g2o::Sim3(); }

inline void transform_vertex::oplusImpl(const g2o::number_t* update_) {
  Eigen::Map<Vec7_t> update(const_cast<g2o::number_t*>(update_));
