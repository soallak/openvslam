...
class graph_opt_edge final
    : public g2o::BaseBinaryEdge<7, g2o::Sim3, shot_vertex, shot_vertex> {
 public:
  ...
  double initialEstimatePossible(const g2o::OptimizableGraph::VertexSet&,
                                 g2o::OptimizableGraph::Vertex*) override;
...
inline double graph_opt_edge::initialEstimatePossible(
    const g2o::OptimizableGraph::VertexSet&, g2o::OptimizableGraph::Vertex*) {
  return 1.0;
}

inline void graph_opt_edge::initialEstimate(
