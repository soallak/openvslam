...
#ifndef M_PI
// M_PI is not part of the C++ standard. Rather it is part of the POSIX
// standard. As such, it is not directly available on Visual C++ (although
// _USE_MATH_DEFINES does exist).
